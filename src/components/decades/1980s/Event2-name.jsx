    ...
    <div className="event-container small panel-gray">
      <div className="event-narrative-content">
        ...
        <p>
          ...
          co-educational world was present at the beginning of the
          decision-making process. After the first female students were
          admitted, attention turned to finding a suitable moniker for the
          College.
        </p>
        <p>
          <em>
