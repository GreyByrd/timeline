...
const Event13 = () => {
  return (
    <div className="event-container event-narrative panel-gray">
      ...
      <p>
        In 1988, <strong>Lorraine Bains ’88</strong> became the first woman and
        first woman of color to serve as the CMC Alumni Association President. A
        banking executive, she continues to serve CMC as a Trustee and a
        co-chair of{" "}
        <a
