    ...
    <div className="event-container narrative panel-gray gradient-border-multi">
      <div className="content">
        <div className="col-5">
          ...
          <p>
            After graduating in 1988, <strong>Lorraine Bains</strong> went on to
            become the first woman and first woman of color to serve as the CMC
            Alumni Association President, taking on the role in 2003. A banking
