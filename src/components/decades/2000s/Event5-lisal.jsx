    ...
    <div className="event-container panel-white">
      <div className="col-2">
        ...
        <p>
          ...
          division of the La Jolla Rough Water competition—her first ocean swim.
          Smith beat out more than 370 exceptional swimmers in her division to
          claim victory in the one-mile race.
        </p>
      </div>
      <div className="col-3">
