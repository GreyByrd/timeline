  ...
  return (
    <div className="event-container panel-purple">
      ...
      <div className="col-3 white-txt">
        ...
        <h2>Notable Dean</h2>
        <p>
          In February 2021, <strong>Heather Antecol</strong>, the Boswell
          Professor of Economics, was named Vice President and the first woman
          to become Dean of the Faculty. Former director of the Berger
