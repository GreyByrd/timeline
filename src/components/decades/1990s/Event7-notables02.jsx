  ...
  return (
    <div className="event-container wide">
      <div className="content">
        <h1 className="honors-yellow-02">Notables</h1>
        <div className="col-1">
        ...
        <div className="col-1">
          ...
          <p>
            ...
            favorite books is Priya Parker’s <em>The Art of Gathering</em>,
            which encourages us to “examine the deeper assumptions behind why we
            gather” around an event or an idea. Daniels has built a career
            connecting people, leading teams at Google and serving on the CMC
            Board of Trustees and the Kravis Leadership Institute Advisory
            Board. “The world needs thoughtful, open-minded leaders,” she said.
          </p>
        </div>
      </div>
    </div>
